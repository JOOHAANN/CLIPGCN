...
class CLIPGCNContrastiveModel(nn.Module):
    def __init__(self, text_model_name: str = "ViT-B/32", device=None, download_root: Optional[str] = None):
        super().__init__()
...
def build_model(text_model_name: str = "ViT-B/32", device=None, download_root: Optional[str] = None):
